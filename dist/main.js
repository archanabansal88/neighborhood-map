...
var Map = function () {
  ...
  _createClass(Map, [{
    ...
    value: function renderMarker() {
      ...
      this.location.forEach(function (value) {
        ...
        value.marker.addListener('click', _this.handleMarkerClick.bind(_this, value));
      });
    }
    ...
    value: function handleMarkerClick(value) {
      var _this2 = this;
      ...
      value.getVenue().then(function (res) {
        _this2.infoWindowMarkup(res);
      }).catch(function () {
        _this2.infowindow.setContent('<div class = "error">There is some problem. Please try again later</div>');
      });
    }
    ...
    key: 'infoWindowMarkup',
    value: function infoWindowMarkup(res) {
      var _res$venues$ = res.venues[0],
          name = _res$venues$.name,
          location = _res$venues$.location,
          contact = _res$venues$.contact;

      var phoneNo = contact.phone ? '<div>phone: ' + contact.phone + '</div>' : '';
      var markUp = '<div>' + name + '</div>\n                      <div>' + location.formattedAddress.join('<br\>') + '</div>' + phoneNo;
...
var CLIENT_ID = 'CV0WB20WFGJC3P13VMHWKYZWM1BDSHFLL2YGZIELBHLNRPPJ';
var CLIENT_SECRET = 'HP4OA3DME10PYDUZ5LW4OTL1R4RBV1OUY0APPVTVNV4ATLUR';
  ...
  _createClass(Venue, [{
    ...
    value: function getVenue() {
      ...
      return new Promise(function (resolve, reject) {
        if (!_this.venue) {
          _this.getVenueDetails(_this.location.lat, _this.location.lng, _this.title).then(function (res) {
            _this.venue = res.response;
            resolve(_this.venue);
          }).catch(function (err) {
            return reject(err);
          });
    ...
    key: 'getVenueDetails',
    value: function getVenueDetails(lat, lng, query) {
      var date = 20180409;
      var api = 'https://api.foursquare.com/v2/venues/search?client_id=' + CLIENT_ID + '&client_secret=' + CLIENT_SECRET + '&ll=' + lat + ',' + lng + '&query=' + query + '&v=' + date + '&radius=250';
...
var ViewModel = function () {
  function ViewModel(location, map, isAppLoaded) {
    var _this = this;
    ...
    this.isSideBarVisible = _knockout2.default.observable(false);
    this.isAppLoaded = _knockout2.default.observable(isAppLoaded);
    this.searchedText = _knockout2.default.observable('');
    this.filterLocation = _knockout2.default.computed(function () {
      if (isAppLoaded) {
        map.closeInfoWindow();
        return _this.location.filter(function (venue) {
          // filtering the venue and displays the filtered subset of location markers
          var isMatched = venue.title.toLowerCase().indexOf(_this.searchedText().toLowerCase()) !== -1;
  ...
  _createClass(ViewModel, [{
    ...
    key: 'displayVenue',
    value: function displayVenue(venue) {
      this.hideSideBar();
...
var _locations = __webpack_require__(1);

var _locations2 = _interopRequireDefault(_locations);

var _venue = __webpack_require__(3);
...
var initMap = function initMap() {
  var venueDetails = _locations2.default.map(function (venue) {
    return new _venue2.default(venue);
  });
  var map = new _map2.default(venueDetails);
  _knockout2.default.applyBindings(new _viewModel2.default(venueDetails, map, true));
};
...
var handleMapError = function handleMapError() {
  _knockout2.default.applyBindings(new _viewModel2.default([], {}, false));
};
